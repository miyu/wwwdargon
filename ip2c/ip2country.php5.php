...
class ip2country {
	...
	function ip2country()
	{
      ...
      global $web_config;
      $this->mysql_host = $web_config["IP2C_HOST"];
      $this->db_name = $web_config["IP2C_DBNAME"]; 
      $this->db_user = $web_config["IP2C_DBUSER"]; 
      $this->db_pass = $web_config["IP2C_DBPASS"]; 
      $this->table_name = $web_config["IP2C_DBTABLE"]; 
	}
